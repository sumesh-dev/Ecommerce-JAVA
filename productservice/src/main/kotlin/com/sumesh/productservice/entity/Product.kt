package com.sumesh.productservice.entity
...
class Product{
    ...
    @field:NotNull(message="Only authorize user can add the product")
     var addBy: ObjectId?= null



    constructor(name: String, img: String, price: Int, desc: String, addBy: ObjectId?) {
        this.name = name
        this.img = img
        this.price = price
        this.desc = desc
    ...
    constructor(_id: ObjectId, name: String, img: String, price: Int, desc: String, addBy: ObjectId?) {
        this._id = _id
        this.name = name
        this.img = img
        this.price = price
